            ...
            <div class="card {!! $printCard !!}">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="password">{{ __('general.password') }} <span class="text-red">*</span></label>
                        <div class="input-group">
                            ...
                            {{ Form::password('password', ['class' => $errors->has('password') ? 'form-control is-invalid' : 'form-control', 'id' => 'password', 'required' => true, 'autocomplete' => 'off']) }}
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="password_confirmation">{{ __('general.password_confirmation') }} <span class="text-red">*</span></label>
                        <div class="input-group">
                            <div class="input-group-prepend datepicker-trigger">
                                <div class="input-group-text">
                            ...
                            {{ Form::password('password_confirmation', ['class' => $errors->has('password_confirmation') ? 'form-control is-invalid' : 'form-control', 'id' => 'password_confirmation', 'required' => true, 'autocomplete' => 'off']) }}
                        </div>
                    </div>
                </div>
                <!-- /.card-body -->
