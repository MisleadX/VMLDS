        ...
        <div class="container-fluid">
            <div class="card {!! $printCard !!}">
                ...
                <div class="card-footer">
                    ...
                    @elseif (in_array($viewType, ['show']) && $data->status == 1)
                        <a href="<?php echo route('admin.' . $thisRoute . '.read', $data->{$masterId}) ?>"
                           class="mb-2 mr-2 btn btn-success" title="{{ __('general.mark_as_read') }}">
                            <i class="fa fa-book"></i><span class=""> {{ __('general.mark_as_read') }}</span>
                        </a>
                    @endif
